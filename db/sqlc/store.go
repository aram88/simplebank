...
// It creates a transfer record, add account entries, and update accounts balance within a sigle database transaction
...
func addMoney(
	...
	if err != nil {
		return //  hamarjeq e  return account1, account2, err
	}
